...
**Design Philosophy**: 
- **Instructions** provide lightweight, always-applied language standards (PEP 8, gofmt, etc.)
- **Skills** provide comprehensive, on-demand domain expertise (APIs, testing, frontend, IaC)
