...
Guide the AI to generate a README_AI_GUIDANCE.md specifying coding patterns and conventions.
...
Present the Problem Clearly: Articulate the issue in detail, including its context within the application, desired outcomes, and any known constraints.
Solicit AI's Design Proposals: Ask the AI to outline possible solutions, specifying the components involved, data flows, and architectural considerations.
Encourage AI to Ask Questions: Prompt the AI to identify ambiguities or missing information by asking clarifying questions.
Iterate on the Design: Review the AI's proposals, provide feedback, and refine the design through multiple iterations until a satisfactory plan is achieved.
Assess Risks and Complexity: Request the AI evaluate proposed solutions for potential risks, side effects, and complexity.
Validate Against the Codebase: Ensure the AI considers the existing codebase, checking for compatibility and potential side effects.
Finalize Before Coding: Confirm that the design aligns with project goals and standards before proceeding to implementation.
...
Review AI-Generated Tests Thoroughly: Validate logic and coverage explicitly. Testing tends to be very bias to pass. This is a big area for more investigation.
Implement Test-Driven Development (TDD): Require AI to clarify requirements and ensure criteria are met before coding.
Utilize Realistic and Diverse Test Data: Instruct AI to reflect real-world scenarios, including edge cases and potential errors.
Maintain Human Oversight: Ensure regular human review to maintain alignment with standards and requirements.
Employ Continuous Testing Practices: Direct the AI to implement continuous testing to promptly identify and address issues.
